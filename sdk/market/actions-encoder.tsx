...
export const encodeActions = ({
  ...
  try {
    ...
    for (let i = 0; i < marketActions.length; i++) {
      ...
      let commandFlag = 1; // simple call

      if (contract_function.stateMutability === "view") {
        commandFlag = 2; // change to static call in order to save gas
      }
