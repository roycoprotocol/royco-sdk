export const WrappedVaultFactoryAbi = [
  {
    type: "constructor",
    inputs: [
      {
        name: "_wrappedVaultImplementation",
        type: "address",
  ...
  {
    type: "function",
    name: "updateWrappedVaultImplementation",
    inputs: [
      {
        name: "newWrappedVaultImplementation",
        type: "address",
        internalType: "address",
      },
    ],
  ...
  {
    type: "event",
    name: "WrappedVaultImplementationUpdated",
    inputs: [
      {
        name: "newWrappedVaultImplementation",
        type: "address",
  ...
  {
    type: "error",
    name: "InvalidWrappedVaultImplementation",
    inputs: [],
  },
  {
    type: "error",
  ...
  { type: "error", name: "ProtocolFeeTooHigh", inputs: [] },
  { type: "error", name: "ReferralFeeTooHigh", inputs: [] },
] as const;
