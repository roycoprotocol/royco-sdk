...
export default defineMarket({
  ...
  description: `wOS is supplied and wS is borrowed with x9.5 leverage. DISCLAIMER: APR of the vault depends on Silo rates, Please DYOR beforing depositing into this high risk vault. High borrowing costs can lead to negative returns in volatile markets. `,
  is_verified: true,
