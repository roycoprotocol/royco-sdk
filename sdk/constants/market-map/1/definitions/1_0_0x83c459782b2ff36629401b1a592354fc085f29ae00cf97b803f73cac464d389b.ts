...
export default defineMarket({
  ...
  description: `Swap USDC for GHO on Balancer V2, receiving a minimum of .999 GHO per USDC, then stake the GHO for stkGHO and lock for 1 month. \n\nCommunity Note: Assets withdrawn are stkGHO and GHO and AAVE. Withdrawn assets may have a cooldown period, and may be unstaked at: (https://app.aave.com/staking/).`,
  is_verified: true,
  native_yield: [
    {
