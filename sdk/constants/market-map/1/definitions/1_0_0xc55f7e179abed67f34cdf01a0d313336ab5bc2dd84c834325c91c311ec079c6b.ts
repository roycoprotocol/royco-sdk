...
export default defineMarket({
  ...
  description: `Stake weETH and hold it approximately until 10 July 2025 (~80 days) to be eligible for staking rewards. Users will be locked in the Levva Vault until the end of the term.`,
  is_verified: true,
