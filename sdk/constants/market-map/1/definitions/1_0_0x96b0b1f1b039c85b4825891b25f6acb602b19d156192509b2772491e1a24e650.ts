...
export default defineMarket({
  ...
  description:
    "DISLAIMER: PLEASE REACH OUT TO YIELDFI TEAM BEFORE WITHDRAWING AT @SGOliveio. yUSD is YieldFi's yield bearing stablecoin, earning 15% - 25% APY in real yield + incentives",
  is_verified: false,
  native_yield: [
    {
